...
namespace UpravnikZgrade.Forme
{
    public partial class Form1 : Form
    {
        ...
        private void upravniciToolStripMenuItem_Click(object sender, EventArgs e)
        {
            UpravniciForma uf = new UpravniciForma();
            uf.MdiParent = this;
            uf.Show();
        }
        ...
        {
            VlasniciForma vf = new VlasniciForma();
            vf.MdiParent = this;
            vf.Show();
        }

        private void zgradeToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ZgradeForma zf = new ZgradeForma();
            zf.MdiParent = this;
            zf.Show();
        }
